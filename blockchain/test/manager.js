...
contract('Manager - testing deployment and creation of components [happy case]', function (accounts) {
    ...
    it("Get content of registry and access the components", () => {
        return managerContract.createComponent(
            ...
            const componentName0 = result_comp0[0];
            const creationgTime0 = result_comp0[1];
            const expiration0 = result_comp0[2];
            const price0 = result_comp0[3];
            const state0 = result_comp0[4];
            const otherInformation0 = result_comp0[5];
            const parentComponentAddress0 = result_comp0[6];
            const childComponentList0 = result_comp0[7];
            const numberOfChildComponents0 = values[1]; 

            // component2 data
            const result_comp1 = values[2]; 
            const componentName1 = result_comp1[0];
            const creationgTime1 = result_comp1[1];
            const expiration1 = result_comp1[2];
            const price1 = result_comp1[3];
            const state1 = result_comp1[4];
            const otherInformation1 = result_comp1[5];
            const parentComponentAddress1 = result_comp1[6];
            const childComponentList1 = result_comp1[7];
    ...
    it("Stage 1: Create a tree of components", () => {
        return Promise.all(
            ...
            const componentName2 = result_comp2[0];
            const creationgTime2 = result_comp2[1];
            const expiration2 = result_comp2[2];
            const price2 = result_comp2[3];
            const state2 = result_comp2[4];
            const otherInformation2 = result_comp2[5];
            const parentComponentAddress2 = result_comp2[6];
            const childComponentList2 = result_comp2[7];

            const result_comp3 = values[1]; 
            const componentName3 = result_comp3[0];
            const creationgTime3 = result_comp3[1];
            const expiration3 = result_comp3[2];
            const price3 = result_comp3[3];
            const state3 = result_comp3[4];
            const otherInformation3 = result_comp3[5];
            const parentComponentAddress3 = result_comp3[6];
            const childComponentList3 = result_comp3[7];
    ...
    it("Stage 2: Travel from component 3 to component 2", () => {
        ...
        return managerContract.getRegistredComponentAtIndex(3).then(componentAddress => {
            ...
            const componentName0 = componentData[0];
            const creationgTime0 = componentData[1];
            const expiration0 = componentData[2];
            const price0 = componentData[3];
            const state0 = componentData[4];
            const otherInformation0 = componentData[5];
            const parentComponentAddress0 = componentData[6];
            const childComponentList0 = componentData[7];
